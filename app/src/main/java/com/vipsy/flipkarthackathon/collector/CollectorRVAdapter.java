...
public class CollectorRVAdapter extends RecyclerView.Adapter<CollectorRVAdapter.PersonViewHolder>{

    List<CollectorPerson> persons;

    public CollectorRVAdapter(List<CollectorPerson> persons){
        this.persons = persons;
    }

    @Override
    public PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.collector_card_view, parent, false);
