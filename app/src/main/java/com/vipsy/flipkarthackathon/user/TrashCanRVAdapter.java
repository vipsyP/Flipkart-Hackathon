...
public class TrashCanRVAdapter extends RecyclerView.Adapter<TrashCanRVAdapter.PersonViewHolder>{

    List<TrashCanPerson> persons;

    public TrashCanRVAdapter(List<TrashCanPerson> persons){
        this.persons = persons;
    }

    @Override
    public PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.trash_can_card_view, parent, false);
