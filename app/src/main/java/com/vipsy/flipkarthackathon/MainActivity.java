...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    class LoginTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            Uri builduri = Uri.parse("FKPrep/Login?").buildUpon().appendQueryParameter("EmailId", email)
    ...
    class RegistrationTask extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            Uri builduri = Uri.parse("FKPrep/Registration?").buildUpon().appendQueryParameter("EmailId", email)
