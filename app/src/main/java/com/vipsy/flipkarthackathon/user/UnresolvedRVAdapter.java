...
public class UnresolvedRVAdapter extends RecyclerView.Adapter<UnresolvedRVAdapter.PersonViewHolder>{

    List<UnresolvedPerson> persons;

    public UnresolvedRVAdapter(List<UnresolvedPerson> persons){
        this.persons = persons;
    }

    @Override
    public PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.unresolved_card_view, parent, false);
