...
public class ResolvedRVAdapter extends RecyclerView.Adapter<ResolvedRVAdapter.PersonViewHolder>{

    List<ResolvedPerson> persons;

    public ResolvedRVAdapter(List<ResolvedPerson> persons){
        this.persons = persons;
    }

    @Override
    public PersonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.resolved_card_view, parent, false);
